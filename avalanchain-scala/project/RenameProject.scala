...
object RenameProject {
  ...
  val settings = Seq(doRename := {
    ...
    val initialRootPackage = "com.avalanchain"
    ...
    info("Done! If you changed your mind -> run `git reset --hard HEAD; git clean -d -f` to restore state before renaming")
  },
