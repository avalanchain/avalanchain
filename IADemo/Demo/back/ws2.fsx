  ...
  socket {
    ...
    while loop do
      ...
      | (Text, data, true) ->
        ...
        let str = Text.Encoding.UTF8.GetString data
...
async { startWebServer { defaultConfig with logger = Targets.create Verbose [||] 
                                            bindings = [ HttpBinding.createSimple HTTP "127.0.0.1" 8082 ]} app } |> Async.Start
