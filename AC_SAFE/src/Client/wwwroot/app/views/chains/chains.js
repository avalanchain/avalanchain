...
(function() {
    'use strict';
    var controllerId = 'chains2';
    angular.module('avalanchain').controller(controllerId, ['common', '$uibModal', 'dataservice', 'jwtservice', '$rootScope','$timeout', chains2]);

    function chains2(common, $uibModal, dataservice, jwtservice, $rootScope, $timeout) {
        ...
        vm.Fork = function (parent) {
            ...
            var modalInstance = $uibModal.open({
                templateUrl: '/wwwroot/app/views/chains/fork.html',
        ...
        vm.Derived = function (parent) {
            ...
            var modalInstance = $uibModal.open({
                templateUrl: '/wwwroot/app/views/chains/derived.html',
                controller: modalCtrl
            });
        };
        vm.test = function() {
