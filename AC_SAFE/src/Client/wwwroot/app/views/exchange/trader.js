(function () {
    ...
    angular.module('avalanchain').controller(controllerId, ['common', '$scope', 'dataservice', 'exchangeservice', '$stateParams','$sce', trader]);

    function trader(common, $scope, dataservice, exchangeservice, $stateParams,$sce) {
