(function () {
    'use strict';
    var controllerId = 'traderbot';
    angular.module('avalanchain').controller(controllerId, ['common', '$scope', 'dataservice','exchangeservice', traderbot]);

    function traderbot(common, $scope, dataservice, exchangeservice) {
